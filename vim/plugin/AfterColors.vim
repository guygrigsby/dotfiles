...
" URL: https://github.com/guygrigsby/dotfiles/vim/plugin/AfterColors.vim
" Comments: Based on the file by the same name by Peter Hodge <toomuchphp-vim@yahoo.com>
" Original URL: http://www.vim.org/scripts/script.php?script_id=1641
" Version: 1.3.2
